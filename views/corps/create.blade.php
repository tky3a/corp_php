  ...
  justify-content: center;
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">新規作成</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <p> <!--エラーメッセージ-->
      ...
      <span class="alert-danger">{{ $errors->first('payment_status') }}</span>
      @endif
    </p>
    <p> <!--エラーメッセージ-->
      @if ($errors->has('postal_code'))
      <span class="alert-danger">{{ $errors->first('postal_code') }}</span>
      @endif
    </p>
    <p> <!--エラーメッセージ-->
      @if ($errors->has('address1'))
      <span class="alert-danger">{{ $errors->first('address1') }}</span>
      @endif
    </p>
    <p> <!--エラーメッセージ-->
      @if ($errors->has('address2'))
      <span class="alert-danger">{{ $errors->first('address2') }}</span>
      @endif
    </p>
                ...
                <div class="card-header ui-sortable-handle" style="cursor: move;">
                    ...
                    <div class="nav">
                      <div class="col-md-6 col-md-offset-3">
                        <form method="post" action="{{ url('/corps/store') }}">
                        {{ csrf_field() }}
